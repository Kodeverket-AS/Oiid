...
export function How() {
  return (
    ...
    bottom-8 -left-12 sm:bottom-12 sm:-left-16 md:bottom-10 md:left-8  lg:bottom-10 lg:left-10 xl:bottom-6 xl:left-12"
          >
            <Image
    ...
    w-full md:w-1/2 h-[320px] md:h-[300px] sm:h-[350px] lg:h-[400px] xl:h-[550px] -top-4 left-16 sm:-top-4  sm:left-18 md:-top-1  md:left-37  lg:-top-4  lg:left-48 xl:-top-5  xl:left-64 "
          >
            <Image
