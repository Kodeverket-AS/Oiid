...
export function How() {
  ...
  useEffect(() => {
    function handleWheel(e: WheelEvent) {
      if (!isHijacked || !scrollSectionRef.current) return;
      e.preventDefault();
  ...
  return (
    <section id="how" ref={sectionRef} className="pt-10">
      <div className="h-full w-full flex justify-center gap-10 items-center flex-col lg:flex-row">
        <div className="w-full text-start p-2 space-y-10 mb-10">
          <div
            ...
            className="flex flex-col gap-40 overflow-y-auto max-h-[25vh] p-2 scroll-smooth no-scrollbar"
          >
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-raleway font-semibold">
                Unleash your inner artist and become part of the fan-driven
                experience.
              </h2>
              <p className="md:w-4/5">
                Superfans can register their own accounts to create personalized
                versions of selected songs, interact and collaborate with other
                superfans, and get early access to concert tickets, exclusive
                events, physical releases, and merch.
              </p>
            </div>
            <div className="space-y-6 ">
              <h2 className="text-3xl font-raleway font-semibold">
              ...
              <p className="md:w-4/5">
                Connect with fellow superfans, share your creations, and build
                your own community within the fanbase.
              </p>
            </div>
            <div className="space-y-6 ">
              <h2 className="text-3xl font-raleway font-semibold">
              ...
              <p className="md:w-4/5">
                Access early-bird tickets, special merchandise, and fan-only
                physical releases.
              </p>
            </div>
          </div>
